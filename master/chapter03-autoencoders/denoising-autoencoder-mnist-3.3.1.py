...
outputs = Conv2DTranspose(
    filters=1, kernel_size=kernel_size, padding="same", activation="sigmoid", name="decoder_output"
)(x)
...
autoencoder.fit(
    x_train_noisy, x_train, validation_data=(x_test_noisy, x_test), epochs=10, batch_size=batch_size
)

...
class VideoDemo:
    def __init__(self, camera=0, width=640, height=480, record=False, filename="demo.mp4"):
        self.camera = camera
        self.width = width
        self.height = height
        self.record = record
...
if __name__ == "__main__":
    ...
    videodemo = VideoDemo(camera=args.camera, record=args.record, filename=args.filename)
    videodemo.loop()

...
class SSD:
    ...
    def build_model(self):
        ...
        anchors, features, ssd = build_ssd(
            self.input_shape, self.backbone, n_layers=self.args.layers, n_classes=self.n_classes
        )
    ...
    def evaluate(self, image_file=None, image=None):
        ...
        class_names, rects, _, _ = show_boxes(
            args, image, classes, offsets, self.feature_shapes, show=show
        )
    ...
    def evaluate_test(self):
        ...
        for key in keys:
            ...
            _, _, class_ids, boxes = show_boxes(
                args, image, classes, offsets, self.feature_shapes, show=False
            )

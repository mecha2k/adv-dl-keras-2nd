...
if __name__ == "__main__":
    ...
    parser.add_argument("-j", "--json", default="labels_train.json", help="Json filename")
    parser.add_argument("-c", "--csv", default="labels_train.csv", help="Csv filename")
    parser.add_argument("-p", "--data_path", default="dataset/drinks", help="Csv filename")
    parser.add_argument("-f", "--factor", default=1.575, type=float, help="Csv filename")

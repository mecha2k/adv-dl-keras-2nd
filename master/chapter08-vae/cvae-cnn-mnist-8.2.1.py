...
def plot_results(models, data, y_label, batch_size=128, model_name="cvae_mnist"):
...
if __name__ == "__main__":
    ...
    plot_results(models, data, y_label=y_label, batch_size=batch_size, model_name=model_name)

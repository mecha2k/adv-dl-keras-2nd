...
def parser():
    ...
    parser.add_argument("--layers", default=3, type=int, help=help_)
    help_ = "Batch size during training"
    parser.add_argument("--batch-size", default=4, type=int, help=help_)
    help_ = "Number of epochs to train"
    parser.add_argument("--epochs", default=100, type=int, help=help_)
    ...
    parser.add_argument("--train-labels", default="segmentation_train.npy", help=help_)
    help_ = "Test data npy filename in --data-path"
    parser.add_argument("--test-labels", default="segmentation_test.npy", help=help_)
    ...
    parser.add_argument("--plot", default=False, action="store_true", help=help_)

...
def conv_layer(
    inputs, filters=32, kernel_size=3, strides=1, use_maxpool=True, postfix=None, activation=None
):
...
def tconv_layer(inputs, filters=32, kernel_size=3, strides=2, postfix=None):
...
def build_fcn(input_shape, backbone, n_classes=4):

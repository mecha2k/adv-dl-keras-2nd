...
if __name__ == "__main__":
    ...
    parser.add_argument("-j", "--json", default="segmentation_train.json", help="Json filename")
    parser.add_argument("-p", "--data-path", default="../dataset/drinks", help="Path to dataset")
    parser.add_argument("--save-filename", default="segmentation_train.npy", help="Path to dataset")
    help_ = "Show and save images"
    parser.add_argument("--show", default=False, action="store_true", help=help_)
